...
VALUES 
    (2,'2023-06-01', 35.12, 'Starbucks', 1, true),
    (2,'2023-06-18', 15.12, 'The Patty Shop_F', 1, true),
    (2,'2023-06-02', 82.47, 'Safeway #4979', 1, true),
    (2,'2023-06-21', 87.02, 'Lunch Lady', 1, true),
    (2,'2023-06-12', 102.72, 'H-MART Dunbar', 1, true),
    (2,'2023-06-09', 8.67, 'Starbucks', 1, true),
    (2,'2023-06-08', 10.97, 'Starbucks', 1, true),
    (2,'2023-06-01', 76.97, 'BC Liquor #136', 1, true),
    (2,'2023-06-07', 31.63, 'BC Liquor #136', 1, true),
    (2,'2023-06-02', 101.97, 'Zarak by Afghan Kitchen', 1, true),
    (2,'2023-06-16', 106.60, 'Safeway #4979', 1, true),
    (2,'2023-06-04', 56.78, 'Uber 072515 SF**POOL*', 2, true),
    (2,'2023-06-08', 49.14, 'Uber 087515 SF**POOL**', 2, true),
    (2,'2023-06-02', 21.14, 'Uber 072512 SF**POOL**', 2, true),
    (2,'2023-06-14', 21.14, 'Honk Parking', 2, true),
    (2,'2023-06-10', 10.14, 'City of Van PAYBYPHONE', 2, true),
    (2,'2023-06-11', 31.12, 'City of Van PAYBYPHONE', 2, true),
    (2,'2023-06-06', 42.11, 'PURE Nail Bar', 5, true),
    (2,'2023-06-15', 30.11, 'PURE Nail Bar', 5, true),
    (2,'2023-06-07', 6.23, 'Subway', 1, true),
    (2,'2023-06-12', 9.99, 'Spotify', 12, true),
    (2,'2023-06-12', 9.99, 'DAZN', 12, true),
    (2,'2023-06-07', 4.99, 'Apple Music', 12, true),
    (2,'2023-06-04', 15.49, 'Netflix', 12, true),
    (2,'2023-06-08', 11.99, 'Disney Plus', 12, true),
    (2,'2023-06-03', 6.99, 'Hayu', 12, true),
    (2,'2023-06-15', 300.00, 'Richmond Shine Dental', 11, true),
    (1,'2023-06-01', 1200.00, 'AUTOMATIC PAYMENT - THANKS', 3, false),
    (1,'2023-06-04', -1100.00, 'Lighthouse Labs',  6, false),
    (1,'2023-06-18', -1100.00, 'Babysitting',  6, false),
    (1,'2023-06-21', -762.00, 'Etsy',  6, false),
    (1,'2023-06-19', 17.89, 'Subway', 1, false),
    (1,'2023-06-23', 68.70, 'Telus Comm BPY', 3, false);
